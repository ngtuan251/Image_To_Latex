...
def crop_image(img, output_path):
    ...
    if len(nnz_inds[0]) == 0: #Height rỗng thì ko lưu vì ko có ảnh,
...
def convert_to_png(formula, dir_output, name, quality=100, density=200,
    ...
    run("magick convert -density {} -quality {} {} -colorspace RGB {}".format(density, quality,
